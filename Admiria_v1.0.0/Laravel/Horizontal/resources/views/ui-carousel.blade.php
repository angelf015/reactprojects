                        ...
                        <div class="card m-b-20">
                            <div class="card-body">
                                ...
                                <div id="carouselExampleCaption" class="carousel slide" data-ride="carousel">
                                    <div class="carousel-inner" role="listbox">
                                        <div class="carousel-item active">
                                            <img src="{{ URL::asset('assets/images/small/img-7.jpg') }}" alt="..." class="img-fluid mx-auto d-block">
                                        ...
                                        <div class="carousel-item">
                                            <img src="{{ URL::asset('assets/images/small/img-5.jpg') }}" alt="..." class="img-fluid mx-auto d-block">
                                            <div class="carousel-caption d-none d-md-block">
                                        ...
                                        <div class="carousel-item">
                                            <img src="{{ URL::asset('assets/images/small/img-4.jpg') }}" alt="..." class="img-fluid mx-auto d-block">
                                            <div class="carousel-caption d-none d-md-block">
