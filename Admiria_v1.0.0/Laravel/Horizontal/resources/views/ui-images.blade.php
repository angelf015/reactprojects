                    ...
                    <div class="col-lg-6">
                        <div class="card m-b-20">
                            <div class="card-body">
                                ...
                                <div class="">
                                    <img class="img-thumbnail" alt="200x200" style="width: 200px; height: 200px;" src="{{ URL::asset('assets/images/small/img-3.jpg') }}" data-holder-rendered="true">
                                </div>
                            </div>
                        </div>
                        <div class="card m-b-20">
                            <div class="card-body">
                                ...
                                <div class="">
                                    <img class="rounded mr-2" alt="200x200" style="width: 200px;" src="{{ URL::asset('assets/images/small/img-4.jpg') }}" data-holder-rendered="true">
                                    <img class="rounded-circle" alt="200x200" src="{{ URL::asset('assets/images/users/avatar-4.jpg') }}" data-holder-rendered="true">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card m-b-20">
                            <div class="card-body">
                                ...
                                <div class="media m-b-30">
                                    <img class="d-flex mr-3 rounded-circle" src="{{ URL::asset('assets/images/users/avatar-6.jpg') }}" alt="Generic placeholder image" height="64">
                                ...
                                <div class="media m-b-30">
                                    <img class="d-flex mr-3 rounded-circle" src="{{ URL::asset('assets/images/users/avatar-2.jpg') }}" alt="Generic placeholder image" height="64">
                                    <div class="media-body">
                                        <h5 class="mt-0 font-18">Media heading</h5>
                                        Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.
                                        <div class="media mt-3">
                                            <a class="d-flex pr-3" href="#">
                                                <img src="{{ URL::asset('assets/images/users/avatar-3.jpg') }}" alt="Generic placeholder image" height="64" class="rounded-circle">
                                            </a>
                                            <div class="media-body">
                                                <h5 class="mt-0 font-18">Media heading</h5>
                                                Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.
                                ...
                                <div class="media">
                                    ...
                                    <img class="d-flex ml-3 rounded-circle" src="{{ URL::asset('assets/images/users/avatar-4.jpg') }}" alt="Generic placeholder image" height="64">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card m-b-20">
                            <div class="card-body">
                                ...
                                <div class="media m-b-30">
                                    <img class="d-flex align-self-start mr-3" src="{{ URL::asset('assets/images/users/avatar-3.jpg') }}" alt="Generic placeholder image" height="64">
                                    <div class="media-body">
                                ...
                                <div class="media m-b-30">
                                    <img class="d-flex align-self-center mr-3" src="{{ URL::asset('assets/images/users/avatar-5.jpg') }}" alt="Generic placeholder image" height="64">
                                    <div class="media-body">
                                ...
                                <div class="media">
                                    <img class="d-flex align-self-end mr-3" src="{{ URL::asset('assets/images/users/avatar-1.jpg') }}" alt="Generic placeholder image" height="64">
                                    <div class="media-body">
