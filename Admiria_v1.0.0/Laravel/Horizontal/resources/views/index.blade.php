                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-vertical">
                                        ...
                                        <tr>
                                            <td>
                                                <img src="{{ URL::asset('assets/images/users/avatar-2.jpg') }}" alt="user-image" class="thumb-sm rounded-circle"/>
                                                Herbert C. Patton
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <img src="{{ URL::asset('assets/images/users/avatar-3.jpg') }}" alt="user-image" class="thumb-sm rounded-circle"/>
                                                Mathias N. Klausen
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <img src="{{ URL::asset('assets/images/users/avatar-4.jpg') }}" alt="user-image" class="thumb-sm rounded-circle"/>
                                                Nikolaj S. Henriksen
                                            </td>
                                            <td><i class="mdi mdi-checkbox-blank-circle text-success"></i> Confirm</td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <img src="{{ URL::asset('assets/images/users/avatar-5.jpg') }}" alt="user-image" class="thumb-sm rounded-circle"/>
                                                Lasse C. Overgaard
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <img src="{{ URL::asset('assets/images/users/avatar-6.jpg') }}" alt="user-image" class="thumb-sm rounded-circle"/>
                                                Kasper S. Jessen
                                            </td>
                                            <td><i class="mdi mdi-checkbox-blank-circle text-success"></i> Confirm</td>
                                            <td>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-vertical mb-1">
                                        ...
                                        <tr>
                                            <td>#12354781</td>
                                            <td>
                                                <img src="{{ URL::asset('assets/images/products/1.jpg') }}" alt="user-image" style="height: 46px;" class="mr-2" />
                                        ...
                                        <tr>
                                            <td>#52140300</td>
                                            <td>
                                                <img src="{{ URL::asset('assets/images/products/2.jpg') }}" alt="user-image" style="height: 46px;" class="mr-2" />
                                        ...
                                        <tr>
                                            <td>#96254137</td>
                                            <td>
                                                <img src="{{ URL::asset('assets/images/products/3.jpg') }}" alt="user-image" style="height: 46px;" class="mr-2" />
                                        ...
                                        <tr>
                                            <td>#12365474</td>
                                            <td>
                                                <img src="{{ URL::asset('assets/images/products/4.jpg') }}" alt="user-image" style="height: 46px;" class="mr-2" />
                                        ...
                                        <tr>
                                            <td>#85214796</td>
                                            <td>
                                                <img src="{{ URL::asset('assets/images/products/5.jpg') }}" alt="user-image" style="height: 46px;" class="mr-2" />
                                                BeoPlay Speaker
                                            </td>
                                            <td><span class="badge badge-pill badge-success">Delivered</span></td>
                                            <td>
