                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="card m-b-20">
                            ...
                            <img class="card-img-bottom img-fluid" src="{{ URL::asset('assets/images/small/img-6.jpg') }}" alt="Card image cap">
                        </div>
                    </div>

                    <div class="col-lg-4">
                        <div class="card m-b-20 card-inverse">
                            <img class="card-img img-fluid" src="{{ URL::asset('assets/images/small/img-7.jpg') }}" alt="Card image">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card-columns">
                            ...
                            <div class="card m-b-20">
                                <img class="card-img img-fluid" src="{{ URL::asset('assets/images/small/img-3.jpg') }}" alt="Card image cap">
                            </div>
