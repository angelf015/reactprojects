                            ...
                            <div class="project-item">
                                <div class="overlay-container">
                                    ...
                                    <div class="project-item-overlay">
                                        ...
                                        <p>
                                            <img src="{{ URL::asset('assets/images/users/avatar-1.jpg') }}" alt="user" class="thumb-sm rounded-circle" />
                            ...
                            <div class="project-item">
                                <div class="overlay-container">
                                    ...
                                    <div class="project-item-overlay">
                                        ...
                                        <p>
                                            <img src="{{ URL::asset('assets/images/users/avatar-2.jpg') }}" alt="user" class="thumb-sm rounded-circle" />
                                            <span class="ml-2">Curtis Marion</span>
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div class="project-item">
                                <div class="overlay-container">
                                    ...
                                    <div class="project-item-overlay">
                                        ...
                                        <p>
                                            <img src="{{ URL::asset('assets/images/users/avatar-3.jpg') }}" alt="user" class="thumb-sm rounded-circle" />
                                            <span class="ml-2">Curtis Marion</span>
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div class="project-item">
                                <div class="overlay-container">
                                    ...
                                    <div class="project-item-overlay">
                                        <h4>Morning Dew</h4>
                                        <p>
                                            <img src="{{ URL::asset('assets/images/users/avatar-4.jpg') }}" alt="user" class="thumb-sm rounded-circle" />
                                            <span class="ml-2">Curtis Marion</span>
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div class="project-item">
                                <div class="overlay-container">
                                    ...
                                    <div class="project-item-overlay">
                                        ...
                                        <p>
                                            <img src="{{ URL::asset('assets/images/users/avatar-5.jpg') }}" alt="user" class="thumb-sm rounded-circle" />
                                            <span class="ml-2">Curtis Marion</span>
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div class="project-item">
                                <div class="overlay-container">
                                    ...
                                    <div class="project-item-overlay">
                                        <h4>Shake It!</h4>
                                        <p>
                                            <img src="{{ URL::asset('assets/images/users/avatar-6.jpg') }}" alt="user" class="thumb-sm rounded-circle" />
                                            <span class="ml-2">Curtis Marion</span>
                                        </p>
                                    </div>
                                </div>
