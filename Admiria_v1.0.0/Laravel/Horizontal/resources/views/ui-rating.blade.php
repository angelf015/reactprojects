...
<link href="{{ URL::asset('assets/plugins/bootstrap-rating/bootstrap-rating.css') }}" rel="stylesheet" type="text/css">
@endsection
...
@section('script')
<!-- Bootstrap rating js -->
<script src="{{ URL::asset('assets/plugins/bootstrap-rating/bootstrap-rating.min.js') }}"></script>
