          ...
          <div className="col-xl-12">
            <div className="card h-unset">
              ...
              <div className="card-body px-0">
                <h5>Instant sends</h5>
                <p className="mb-1">
                  Allow other users to see that you use Tende and send you
                  crypto instantly
                </p>
            ...
            <div className="card h-unset mb-0">
              <div className="card-header px-0">
                <h4 className="card-title">Your Tende account</h4>
              </div>
              <div className="card-body px-0">
                <p>
                ...
                <div className="privacy-content">
                  <h5>Request Data</h5>
                  <p>Request a copy of my personal data held by Tende.</p>
                ...
                <div className="privacy-content">
                  ...
                  <p>Request that Tende stops processing my personal data.</p>
                  <a href="#" className="btn btn-outline-primary">
                    Request restriction
                  </a>
                </div>
