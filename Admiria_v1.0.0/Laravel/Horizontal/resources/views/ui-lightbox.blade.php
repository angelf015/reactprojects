                                ...
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <a class="image-popup-vertical-fit" href="{{ URL::asset('assets/images/small/img-2.jpg') }}" title="Caption. Can be aligned it to any side and contain any HTML.">
                                            <img class="img-responsive" src="{{ URL::asset('assets/images/small/img-2.jpg') }}"  width="145">
                                        </a>
                                    </div>
                                    <div class="col-6">
                                        ...
                                        <a class="image-popup-no-margins" href="{{ URL::asset('assets/images/small/img-3.jpg') }}">
                                            <img class="img-responsive" src="{{ URL::asset('assets/images/small/img-3.jpg') }}" width="75">
                                        </a>
                        ...
                        <div class="card m-b-20">
                            <div class="card-body">
                                ...
                                <div class="popup-gallery">
                                    <a class="pull-left" href="{{ URL::asset('assets/images/small/img-1.jpg') }}" title="Project 1">
                                        <div class="img-responsive">
                                            <img src="{{ URL::asset('assets/images/small/img-1.jpg') }}" width="120">
                                        </div>
                                    </a>
                                    <a class="pull-left" href="{{ URL::asset('assets/images/small/img-2.jpg') }}" title="Project 2">
                                        <div class="img-responsive">
                                            <img src="{{ URL::asset('assets/images/small/img-2.jpg') }}" width="120">
                                        </div>
                                    </a>
                                    <a class="pull-left" href="{{ URL::asset('assets/images/small/img-3.jpg') }}" title="Project 3">
                                        <div class="img-responsive">
                                            <img src="{{ URL::asset('assets/images/small/img-3.jpg') }}" width="120">
                                        </div>
                                    </a>
                                    <a class="pull-left" href="{{ URL::asset('assets/images/small/img-4.jpg') }}" title="Project 4">
                                        <div class="img-responsive">
                                            <img src="{{ URL::asset('assets/images/small/img-4.jpg') }}" width="120">
                                        </div>
                                    </a>
                                    <a class="pull-left" href="{{ URL::asset('assets/images/small/img-5.jpg') }}" title="Project 5">
                                        <div class="img-responsive">
                                            <img src="{{ URL::asset('assets/images/small/img-5.jpg') }}" width="120">
                                        </div>
                                    </a>
                                    <a class="pull-left" href="{{ URL::asset('assets/images/small/img-6.jpg') }}" title="Project 6">
                                        <div class="img-responsive">
                                            <img src="{{ URL::asset('assets/images/small/img-6.jpg') }}" width="120">
                                        </div>
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="card m-b-20">
                            <div class="card-body">
                                ...
                                <div class="zoom-gallery">
                                    <a class="pull-left" href="{{ URL::asset('assets/images/small/img-3.jpg') }}" title="Project 1"><img src="{{ URL::asset('assets/images/small/img-3.jpg') }}" width="275"></a>
                                    <a class="pull-left" href="{{ URL::asset('assets/images/small/img-7.jpg') }}" title="Project 2"><img src="{{ URL::asset('assets/images/small/img-7.jpg') }}" width="275"></a>
                                </div>
                            </div>
                        </div>
                    </div>
